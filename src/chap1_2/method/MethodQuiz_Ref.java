...
public class MethodQuiz_Ref {
    ...
    static String[] copy(int capacity) {
        ...
        // 늘어난 부분엔 복사할 데이터가 없음, 즉, 원본 배열보다 더 돌면 foods[i]가 존재하지 않아서 ArrayIndexOutOfBoundsException 에러가 터짐
        // 줄였을 때는 줄인 만큼 회전
